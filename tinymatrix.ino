...
// with modifications for the ATTiny2313 by Silviu Vulcan //
// www.silviuvulcan.ro                                    //
////////////////////////////////////////////////////////////
...
// Kingbright ta07-11gwa works as 747
#define LTP   747
//#define LTP     757
...
void render_buffer()
{
        ...
        switch(mode)
        {
// the ATTiny2313 has only 2k this way it fits with 8 bytes to spare
//              case 1: render_checkerboard();  break;
                case 1: render_psycho();        break;
                case 2: render_heartbeat();     break;
                case 3: render_rain();          break;
                case 4: render_fire();          break;
                case 5: render_character(2);    break;
                case 6: render_character(3);    break;
                case 7: render_character(4);    break;
                case 8: render_character(5);    break;
                case 9: render_character(6);   break;
                case 10: render_character(7);   break;
                case 11: render_character(8);   break;
                case 12: render_character(9);   break;
                case 13: render_character(10);  break;
                case 14: render_character(11);  break;
                case 15: render_character(12);  break;
                case 16: render_character(13);  break;
                case 17: render_character(14);  break;
        }
}
...
{ 
        ...
        for (;;)
        {
                ...
                {       
                        refresh_line();
                        check_inputs();
// 10000 gives around 12 seconds per character
                        if (cnt==10000) { mode++; need_render_frame = 1; cnt = 0;}
                        else cnt++;
                }
        }       
}
